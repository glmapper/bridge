...
/**
 * BridgeUrl - Uniform Resource Locator (Immutable, ThreadSafe)
 * <p>
 * url example:
 * <ul>
...
public class BridgeUrl implements Serializable {
    ...
    public BridgeUrl(String protocol, String host, int port) {
        this(protocol, null, null, host, port, null, (Map<String, String>) null);
    }

    public BridgeUrl(String protocol, String host, int port, String[] pairs) {
        this(protocol, null, null, host, port, null, CollectionUtils.toStringMap(pairs));
    }

    public BridgeUrl(String protocol, String host, int port, Map<String, String> parameters) {
        this(protocol, null, null, host, port, null, parameters);
    }

    public BridgeUrl(String protocol, String host, int port, String path) {
        this(protocol, null, null, host, port, path, (Map<String, String>) null);
    }

    public BridgeUrl(String protocol, String host, int port, String path, String... pairs) {
        this(protocol, null, null, host, port, path, CollectionUtils.toStringMap(pairs));
    }

    public BridgeUrl(String protocol, String host, int port, String path, Map<String, String> parameters) {
    ...
    public BridgeUrl(String protocol, String username, String password, String host, int port, String path, Map<String, String> parameters) {
     ...
     * Parse url string
     *
     * @param url BridgeUrl string
     * @return BridgeUrl instance
     * @see BridgeUrl
     */
    public static BridgeUrl valueOf(String url) {
        ...
        // separate between body and parameters
        int i = url.indexOf("?");
        if (i >= 0) {
        ...
        return new BridgeUrl(protocol, username, password, host, port, path, parameters);
    }
    ...
    public BridgeUrl setProtocol(String protocol) {
        return new BridgeUrl(protocol, username, password, host, port, path, getParameters());
    }
    ...
    public BridgeUrl setUsername(String username) {
        return new BridgeUrl(protocol, username, password, host, port, path, getParameters());
    }
    ...
    public BridgeUrl setPassword(String password) {
        return new BridgeUrl(protocol, username, password, host, port, path, getParameters());
    }
    ...
    public BridgeUrl setHost(String host) {
        return new BridgeUrl(protocol, username, password, host, port, path, getParameters());
    }

    /**
     * Fetch IP address for this BridgeUrl.
     * <p>
    ...
    public BridgeUrl setPort(int port) {
        return new BridgeUrl(protocol, username, password, host, port, path, getParameters());
    }
    ...
    public BridgeUrl setAddress(String address) {
    ...
    public List<BridgeUrl> getBackupUrls() {
        List<BridgeUrl> bridgeUrls = new ArrayList<BridgeUrl>();
        bridgeUrls.add(this);
        String[] backups = getParameter(Constants.BACKUP_KEY, new String[0]);
        if (backups != null && backups.length > 0) {
            for (String backup : backups) {
                bridgeUrls.add(this.setAddress(backup));
            }
        }
        return bridgeUrls;
    }
    ...
    public BridgeUrl setPath(String path) {
        return new BridgeUrl(protocol, username, password, host, port, path, getParameters());
    }
    ...
    private Map<String, BridgeUrl> getUrls() {
        if (urls == null) { // concurrent initialization is tolerant
            urls = new ConcurrentHashMap<String, BridgeUrl>();
        }
        return urls;
    }

    public BridgeUrl getUrlParameter(String key) {
        BridgeUrl u = getUrls().get(key);
        if (u != null) {
            return u;
        }
    ...
    public String getMethodParameterAndDecoded(String method, String key) {
        return BridgeUrl.decode(getMethodParameter(method, key));
    }

    public String getMethodParameterAndDecoded(String method, String key, String defaultValue) {
        return BridgeUrl.decode(getMethodParameter(method, key, defaultValue));
    }
    ...
    public BridgeUrl addParameterAndEncoded(String key, String value) {
        if (value == null || value.length() == 0) {
            return this;
        }
    ...
    public BridgeUrl addParameter(String key, boolean value) {
        return addParameter(key, String.valueOf(value));
    }

    public BridgeUrl addParameter(String key, char value) {
        return addParameter(key, String.valueOf(value));
    }

    public BridgeUrl addParameter(String key, byte value) {
        return addParameter(key, String.valueOf(value));
    }

    public BridgeUrl addParameter(String key, short value) {
        return addParameter(key, String.valueOf(value));
    }

    public BridgeUrl addParameter(String key, int value) {
        return addParameter(key, String.valueOf(value));
    }

    public BridgeUrl addParameter(String key, long value) {
        return addParameter(key, String.valueOf(value));
    }

    public BridgeUrl addParameter(String key, float value) {
        return addParameter(key, String.valueOf(value));
    }

    public BridgeUrl addParameter(String key, double value) {
        return addParameter(key, String.valueOf(value));
    }

    public BridgeUrl addParameter(String key, Enum<?> value) {
        if (value == null) {
            return this;
        }
        return addParameter(key, String.valueOf(value));
    ...
    public BridgeUrl addParameter(String key, Number value) {
        if (value == null) {
            return this;
        }
        return addParameter(key, String.valueOf(value));
    ...
    public BridgeUrl addParameter(String key, CharSequence value) {
        if (value == null || value.length() == 0) {
            return this;
        }
        return addParameter(key, String.valueOf(value));
    ...
    public BridgeUrl addParameter(String key, String value) {
        ...
        map.put(key, value);
        return new BridgeUrl(protocol, username, password, host, port, path, map);
    }
     ...
     * @return A new BridgeUrl
     */
    public BridgeUrl addParameters(Map<String, String> parameters) {
    ...
    public BridgeUrl addParametersIfAbsent(Map<String, String> parameters) {
        if (parameters == null || parameters.size() == 0) {
            return this;
        }
    ...
    public BridgeUrl addParameters(String... pairs) {
...
//    }
    ...
    public BridgeUrl removeParameters(Collection<String> keys) {
    ...
    public BridgeUrl removeParameters(String... keys) {
    ...
    public BridgeUrl clearParameters() {
        return new BridgeUrl(protocol, username, password, host, port, path, new HashMap<String, String>());
    }
    ...
    public BridgeUrl setServiceInterface(String service) {
